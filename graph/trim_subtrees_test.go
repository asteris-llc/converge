...
func TestTrimSubtreesRemovesDuplicates(t *testing.T) {
...
func TestTrimSubtreesMigratesDependencies(t *testing.T) {
	defer helpers.HideLogs(t)()
...
func TestTrimSubtreesRemovesChildren(t *testing.T) {
	defer helpers.HideLogs(t)()
