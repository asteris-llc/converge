...
// CoreosDbus implements DbusConnector for coreos/go-systemd/dbus
type CoreosDbus struct{}

// New generates a new dbus.Connection
func (CoreosDbus) New() (SystemdDbus, error) { return dbus.New() }
