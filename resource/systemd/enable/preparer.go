...
func (p *Preparer) Prepare(render resource.Renderer) (resource.Task, error) {
	...
	enableModule := &Enable{Unit: unit, Runtime: p.Runtime, Force: p.Force, Timeout: t}
	return enableModule, ValidateTask(enableModule)
}

func ValidateTask(enableModule *Enable) error {
	if enableModule.Unit == "" {
